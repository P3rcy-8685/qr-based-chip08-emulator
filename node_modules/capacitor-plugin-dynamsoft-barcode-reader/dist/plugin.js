var capacitorDBR = (function (exports, core, dynamsoftJavascriptBarcode, dynamsoftCameraEnhancer) {
    'use strict';
    ...
    const DBR = core.registerPlugin('DBR', {
        web: () => Promise.resolve().then(function () { return web; }).then(m => new m.DBRWeb()),
    });

    dynamsoftJavascriptBarcode.BarcodeReader.engineResourcePath = "https://cdn.jsdelivr.net/npm/dynamsoft-javascript-barcode@9.2.13/dist/";
    dynamsoftCameraEnhancer.CameraEnhancer.defaultUIElementURL = "https://cdn.jsdelivr.net/npm/dynamsoft-camera-enhancer@3.0.1/dist/dce.ui.html";
    class DBRWeb extends core.WebPlugin {
        constructor() {
            super(...arguments);
            this.reader = null;
            this.enhancer = null;
        ...
        async initialize(options) {
            if (this.reader === null) {
                if (options) {
                    if (options.license) {
                        dynamsoftJavascriptBarcode.BarcodeReader.license = options.license;
                    }
                }
                this.enhancer = await dynamsoftCameraEnhancer.CameraEnhancer.createInstance();
                this.reader = await dynamsoftJavascriptBarcode.BarcodeScanner.createInstance();
                ...
                await this.enhancer.setUIElement(dynamsoftCameraEnhancer.CameraEnhancer.defaultUIElementURL);
        ...
        async setEngineResourcePath(path) {
            dynamsoftJavascriptBarcode.BarcodeReader.engineResourcePath = path;
        }
...
})({}, capacitorExports, dynamsoftJavascriptBarcode, dynamsoftCameraEnhancer);
