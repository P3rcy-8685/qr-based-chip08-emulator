...
import { defineCustomElement as defineCustomElement$k } from '@ionic/core/components/ion-datetime-button.js';
...
import { defineCustomElement as defineCustomElement$Z } from '@ionic/core/components/ion-slide.js';
import { defineCustomElement as defineCustomElement$_ } from '@ionic/core/components/ion-slides.js';
...
import { defineCustomElement as defineCustomElement$17 } from '@ionic/core/components/ion-virtual-scroll.js';
...
import { defineCustomElement as defineCustomElement$1b } from '@ionic/core/components/ion-picker.js';
...
const IonDatetimeButton = /*@__PURE__*/ defineContainer('ion-datetime-button', defineCustomElement$k, [
    'color',
    'disabled',
    'datetime'
]);
...
const IonProgressBar = /*@__PURE__*/ defineContainer('ion-progress-bar', defineCustomElement$J, [
    'type',
    'reversed',
    'value',
    'buffer',
...
const IonRadio = /*@__PURE__*/ defineContainer('ion-radio', defineCustomElement$K, [
    'color',
    'name',
    'disabled',
    'value',
...
const IonRadioGroup = /*@__PURE__*/ defineContainer('ion-radio-group', defineCustomElement$L, [
    'allowEmptySelection',
    'name',
    'value',
    'ionChange'
], 'value', 'v-ion-change', 'ionChange');
const IonRange = /*@__PURE__*/ defineContainer('ion-range', defineCustomElement$M, [
    'color',
    'debounce',
    'name',
    'dualKnobs',
...
const IonRefresher = /*@__PURE__*/ defineContainer('ion-refresher', defineCustomElement$N, [
    'pullMin',
    'pullMax',
    'closeDuration',
    'snapbackDuration',
...
const IonRefresherContent = /*@__PURE__*/ defineContainer('ion-refresher-content', defineCustomElement$O, [
    'pullingIcon',
    'pullingText',
    'refreshingSpinner',
    'refreshingText'
]);
const IonReorder = /*@__PURE__*/ defineContainer('ion-reorder', defineCustomElement$P);
const IonReorderGroup = /*@__PURE__*/ defineContainer('ion-reorder-group', defineCustomElement$Q, [
    'disabled',
    'ionItemReorder'
]);
const IonRippleEffect = /*@__PURE__*/ defineContainer('ion-ripple-effect', defineCustomElement$R, [
    'type'
]);
const IonRow = /*@__PURE__*/ defineContainer('ion-row', defineCustomElement$S);
const IonSearchbar = /*@__PURE__*/ defineContainer('ion-searchbar', defineCustomElement$T, [
    'color',
    'animated',
    'autocomplete',
    'autocorrect',
...
const IonSegment = /*@__PURE__*/ defineContainer('ion-segment', defineCustomElement$U, [
    'color',
    'disabled',
    'scrollable',
    'swipeGesture',
...
const IonSegmentButton = /*@__PURE__*/ defineContainer('ion-segment-button', defineCustomElement$V, [
    'disabled',
    'layout',
    'type',
    'value'
], 'value', 'v-ion-change', 'ionChange');
const IonSelect = /*@__PURE__*/ defineContainer('ion-select', defineCustomElement$W, [
    'disabled',
    'cancelText',
    'okText',
    'placeholder',
...
const IonSelectOption = /*@__PURE__*/ defineContainer('ion-select-option', defineCustomElement$X, [
    'disabled',
    'value'
]);
const IonSkeletonText = /*@__PURE__*/ defineContainer('ion-skeleton-text', defineCustomElement$Y, [
    'animated'
]);
const IonSlide = /*@__PURE__*/ defineContainer('ion-slide', defineCustomElement$Z);
const IonSlides = /*@__PURE__*/ defineContainer('ion-slides', defineCustomElement$_, [
    'options',
    'pager',
    'scrollbar',
    'ionSlidesDidLoad',
...
const IonSplitPane = /*@__PURE__*/ defineContainer('ion-split-pane', defineCustomElement$10, [
    'contentId',
    'disabled',
    'when',
    'ionSplitPaneVisible'
]);
const IonText = /*@__PURE__*/ defineContainer('ion-text', defineCustomElement$11, [
    'color'
]);
const IonTextarea = /*@__PURE__*/ defineContainer('ion-textarea', defineCustomElement$12, [
    'fireFocusEvents',
    'color',
    'autocapitalize',
    'autofocus',
...
const IonThumbnail = /*@__PURE__*/ defineContainer('ion-thumbnail', defineCustomElement$13);
const IonTitle = /*@__PURE__*/ defineContainer('ion-title', defineCustomElement$14, [
    'color',
    'size',
    'ionStyle'
]);
const IonToggle = /*@__PURE__*/ defineContainer('ion-toggle', defineCustomElement$15, [
    'color',
    'name',
    'checked',
    'disabled',
...
const IonToolbar = /*@__PURE__*/ defineContainer('ion-toolbar', defineCustomElement$16, [
    'color'
]);
const IonVirtualScroll = /*@__PURE__*/ defineContainer('ion-virtual-scroll', defineCustomElement$17, [
    'approxItemHeight',
    'approxHeaderHeight',
    'approxFooterHeight',
    'headerFn',
...
const IonActionSheet = /*@__PURE__*/ defineOverlayContainer('ion-action-sheet', defineCustomElement$18, ['animated', 'backdropDismiss', 'buttons', 'cssClass', 'enterAnimation', 'header', 'htmlAttributes', 'keyboardClose', 'leaveAnimation', 'mode', 'subHeader', 'translucent'], actionSheetController$1);
const IonAlert = /*@__PURE__*/ defineOverlayContainer('ion-alert', defineCustomElement$19, ['animated', 'backdropDismiss', 'buttons', 'cssClass', 'enterAnimation', 'header', 'htmlAttributes', 'inputs', 'keyboardClose', 'leaveAnimation', 'message', 'mode', 'subHeader', 'translucent'], alertController$1);
const IonLoading = /*@__PURE__*/ defineOverlayContainer('ion-loading', defineCustomElement$1a, ['animated', 'backdropDismiss', 'cssClass', 'duration', 'enterAnimation', 'htmlAttributes', 'keyboardClose', 'leaveAnimation', 'message', 'mode', 'showBackdrop', 'spinner', 'translucent'], loadingController$1);
const IonPicker = /*@__PURE__*/ defineOverlayContainer('ion-picker', defineCustomElement$1b, ['animated', 'backdropDismiss', 'buttons', 'columns', 'cssClass', 'duration', 'enterAnimation', 'htmlAttributes', 'keyboardClose', 'leaveAnimation', 'mode', 'showBackdrop'], pickerController$1);
const IonToast = /*@__PURE__*/ defineOverlayContainer('ion-toast', defineCustomElement$1c, ['animated', 'buttons', 'color', 'cssClass', 'duration', 'enterAnimation', 'header', 'htmlAttributes', 'icon', 'keyboardClose', 'leaveAnimation', 'message', 'mode', 'position', 'translucent'], toastController$1);
const IonModal = /*@__PURE__*/ defineOverlayContainer('ion-modal', defineCustomElement$1d, ['animated', 'backdropBreakpoint', 'backdropDismiss', 'breakpoints', 'canDismiss', 'enterAnimation', 'handle', 'handleBehavior', 'htmlAttributes', 'initialBreakpoint', 'isOpen', 'keepContentsMounted', 'keyboardClose', 'leaveAnimation', 'mode', 'presentingElement', 'showBackdrop', 'swipeToClose', 'trigger']);
const IonPopover = /*@__PURE__*/ defineOverlayContainer('ion-popover', defineCustomElement$1e, ['alignment', 'animated', 'arrow', 'backdropDismiss', 'component', 'componentProps', 'dismissOnSelect', 'enterAnimation', 'event', 'htmlAttributes', 'isOpen', 'keepContentsMounted', 'keyboardClose', 'leaveAnimation', 'mode', 'reference', 'showBackdrop', 'side', 'size', 'translucent', 'trigger', 'triggerAction']);
...
const modalController = /*@__PURE__*/ createController(defineCustomElement$1d, modalController$1, true);
const popoverController = /*@__PURE__*/ createController(defineCustomElement$1e, popoverController$1, true);
const alertController = /*@__PURE__*/ createController(defineCustomElement$19, alertController$1);
const actionSheetController = /*@__PURE__*/ createController(defineCustomElement$18, actionSheetController$1);
const loadingController = /*@__PURE__*/ createController(defineCustomElement$1a, loadingController$1);
const pickerController = /*@__PURE__*/ createController(defineCustomElement$1b, pickerController$1);
const toastController = /*@__PURE__*/ createController(defineCustomElement$1c, toastController$1);
